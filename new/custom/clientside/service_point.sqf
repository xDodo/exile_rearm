...
//====================== general settings
_folder = "custom\clientside\"; // folder where the service point scripts are saved, relative to the mission file
_servicePointClasses = ["B_Slingload_01_Ammo_F","Land_CarService_F","Land_fs_roof_F"]; // service point classes (can be house, vehicle and unit classes)
